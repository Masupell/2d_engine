...
impl Button
{
    ...
    pub fn draw(&self, render_ctx: &mut crate::RenderContext, z_index: u32, shader_id: u8)
    {
        ...
        render_ctx.graphics.renderer.draw_texture(0, render_ctx.graphics.renderer.matrix(center, (self.rect.width as f32, self.rect.height as f32), 0.0), self.texture_id, z_index, shader_id);
    }
